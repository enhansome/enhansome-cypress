...
* [GitHub Repo](https://github.com/cypress-io/cypress) ⭐ 51,029 | 🐛 1,083 | 🌐 TypeScript | 📅 2026-09-06
* [Release Notes](https://github.com/cypress-io/cypress/releases) ⭐ 51,029 | 🐛 1,083 | 🌐 TypeScript | 📅 2026-09-06
...
* [Cypress Dark](https://github.com/bahmutov/cypress-dark) ⭐ 152 | 🐛 26 | 🌐 CSS | 📅 2026-09-03 - Dark and Halloween color themes for Cypress.io test runner - [Gleb Bahmutov](https://github.com/bahmutov);
...
* [Agent QA](https://github.com/vostride/agent-qa) ⭐ 901 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - Open-source, self-improving QA agent for software teams. It runs natural-language web and mobile tests, keeps persistent testing context, and self-heals tests as applications change.
...
* [Cypress Keycloak Commands](https://github.com/Fredx87/cypress-keycloak-commands) ⭐ 70 | 🐛 39 | 🌐 TypeScript | 📅 2024-04-26 - Cypress commands for authenticate users with Keycloak Identity Provider.
...
* [Cypress Angular Unit Test](https://github.com/bahmutov/cypress-angular-unit-test) ⭐ 160 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-03 - Test Angular component using Cypress Test Runner.
...
* [Cypress Angular Unit Test](https://github.com/bahmutov/cypress-angularjs-unit-test) ⭐ 22 | 🐛 17 | 🌐 JavaScript | 📅 2026-09-01 - Unit test Angularjs code using Cypress Test Runner.
* [Cypress Cycle Unit Test](https://github.com/bahmutov/cypress-cycle-unit-test) ⭐ 3 | 🐛 17 | 🌐 JavaScript | 📅 2026-09-03 - Test Cycle.js components using Cypress Test Runner.

#### Forms

* [Cypress Forms Commands](https://github.com/SamuelTrottier/cypress-forms-commands) ⭐ 4 | 🐛 2 | 🌐 TypeScript | 📅 2021-07-11 - Easier form filling and validation

#### Visual Testing

* [Cypress Image Snapshot](https://github.com/palmerhq/cypress-image-snapshot) ⭐ 890 | 🐛 122 | 🌐 JavaScript | 📅 2024-04-10
* [Cypress Visual Regression](https://github.com/mjhea0/cypress-visual-regression) ⭐ 661 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-03
...
* [Cypress Blink Test](https://github.com/PatrickWalker/cypress-visual-regression) ⭐ 10 | 🐛 0 | 🌐 JavaScript | 📅 2018-11-30
...
* [Cypress testomatio reporter](https://github.com/testomatio/reporter/blob/master/docs/frameworks.md#Cypress) ⭐ 152 | 🐛 24 | 🌐 JavaScript | 📅 2026-09-06
...
* [Cypress Health Check](https://github.com/bdimitrovski/cypress-healthcheck) ⭐ 30 | 🐛 4 | 🌐 JavaScript | 📅 2026-04-02
* [Cypress Msteams reporter](https://github.com/maritome/cypress-msteams-reporter) ⭐ 14 | 🐛 9 | 🌐 JavaScript | 📅 2023-04-27
* [Cypress teamcity reporter](https://github.com/prma85/cypress-teamcity-reporter) ⭐ 11 | 🐛 0 | 🌐 JavaScript | 📅 2023-12-04
* [Autoset status cypress testrail reporter](https://github.com/dkuznetsov21/autoset-status-cypress-testrail-reporter) ⭐ 6 | 🐛 2 | 🌐 TypeScript | 📅 2021-09-27

### Containers

* [Cypress Docker images](https://github.com/cypress-io/cypress-docker-images) ⭐ 1,058 | 🐛 23 | 🌐 Dockerfile | 📅 2026-09-03 - Docker images with Cypress dependencies and browsers.
